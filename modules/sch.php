<?php
if ((strpos($message, "/sch") === 0) || (strpos($message, "!sch") === 0) || (strpos($message, ".sch") === 0)) {
	...
	if (in_array($chatId, $pros)) {
		...
		if (strpos($fimaa, "$750 Charged ✅") || strpos($fimaa, "CHARGED CC")) {
			$pass = 'CVC CHECK PASS ✅';
		}
		...
		editMessage($chatId, "<b>✦ 𝗮𝗿𝘁𝗲𝗿𝘅𝘀𝗸 𝗰𝗵𝗸 ! - Status - $sat%0A━━━━━━━━━━━━━%0A[✦] GATE: STRIPE KILLER $750%0A[✦] CC: <code>$lista</code>%0A[✦] STATUS: $pass%0A[✦] RESPONSE: $msg%0A[✦] BUG BIN: $isbug%0A$binrs%0A━━━━━━━━━━━━━%0A[✦] TIME TAKEN: $execution_time's%0A[✦] Checked By: @$username%0A[✦] UserID: $userId%0A[✦] Premium Activated: $stat%0A</b>", $mes_id);
	} else {
