...
if ((strpos($message, "/spp") === 0) || (strpos($message, "!spp") === 0) || (strpos($message, ".spp") === 0)) {
	...
	if (in_array($chatId, $pros)) {
		...
		editMessage($chatId, "<b>✦ 𝗮𝗿𝘁𝗲𝗿𝘅𝘀𝗸 𝗰𝗵𝗸 ! - Status - $sat%0A━━━━━━━━━━━━━%0A[✦] GATE: STRIPE CHARGE €4%0A[✦] CC: <code>$lista</code>%0A[✦] STATUS: $pass%0A[✦] RESPONSE: $msg%0A[✦] BUG BIN: $isbug%0A$binrs%0A━━━━━━━━━━━━━%0A[✦] TIME TAKEN: $execution_time's%0A[✦] Checked By: @$username%0A[✦] UserID: $userId%0A[✦] Premium Activated: $stat%0A</b>", $mes_id);
	} else {
